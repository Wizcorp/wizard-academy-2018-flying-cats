...
export class PlayerClass {
    ...
    limitedPlayerMoveArea() {
		...
		if (this.playerPosition.x < 0+(this.mySprite.width/2)){
			this.playerPosition.x = 0+(this.mySprite.width/2);
		}

		if (this.playerPosition.y<0+(this.mySprite.height/2)){
			this.playerPosition.y=0+(this.mySprite.height/2);
		}

		if (this.playerPosition.x >this.game.width-(this.mySprite.width/2)) {
			this.playerPosition.x = this.game.width-(this.mySprite.width/2);
		}

		if (this.playerPosition.y>this.game.height-(this.mySprite.height/2)){
			this.playerPosition.y=this.game.height-(this.mySprite.height/2);
		} 		
	}
}
